...
*
*
* Plugin Name: MkRapel Regiones y Estados de Mexico para WC
...
if(is_woocommerce_active()) {
	...
	require MKRAPEL_MX_PATH . 'classes/class-mkrapel-mx.php';
	...
	require_once ('classes/mkrapel-mx-states-places.php');
    require_once ('classes/mkrapel-mx-filter-by-cities.php');
