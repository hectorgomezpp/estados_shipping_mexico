 ...
 * @subpackage wc-ciudades-y-estados-de-mexico/includes
 */

function filters_by_cities_method() {
    if ( ! class_exists( 'Filters_By_Cities_Method_MX' ) ) {
        class Filters_By_Cities_Method_MX extends WC_Shipping_Method {
            
            public $single_method;
            public $cost;
            public $cities;
            public $type;
            public $fee_cost;
            ...
            public function __construct($instance_id = 0) {
                ...
                $this->method_title       	= __( 'Envío por Ciudad MX');
            ...
            public function define_instance_form_fields() { return include 'mkrapel-mx-settings-filter-by-cities.php'; }
            ...
            public function showCitiesRegions() {
                ...
                foreach ($zones as $zone){
                    if (strpos($zone->code, ':') !== false){
                        ...
                        $states = MkRapel_Region_Ciudad_MX::get_places( $place[0] );  /* Change for country */
