...
if(!class_exists('MKRAPEL_MX_Utils')):

class MKRAPEL_MX_Utils {
	const OPTION_KEY_ADVANCED_SETTINGS = 'mkrapel_mx_advanced_settings';
	...
	public static function MKRAPEL_MX_version_check( $version = '4.0' ) {
		if(MKRAPEL_MX_VERSION && version_compare( MKRAPEL_MX_VERSION, $version, ">=" ) ) {
	  		return true;
		}
	  	return false;
	}
	 ...
	 **************************************/
	 public static function get_advanced_settings(){
		...
		$settings = apply_filters('mkrapel_mx_advanced_settings', $settings);
