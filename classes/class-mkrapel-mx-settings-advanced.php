...
if(!class_exists('MKRAPEL_MX_Settings_Advanced')):

class MKRAPEL_MX_Settings_Advanced {
	...
	public function save_advanced_settings($settings){
		$result = update_option(MKRAPEL_MX_Utils::OPTION_KEY_ADVANCED_SETTINGS, $settings);
		return $result;
	}
	
	private function reset_settings(){
		delete_option(MKRAPEL_MX_Utils::OPTION_KEY_ADVANCED_SETTINGS);
	...
	private function render_plugin_settings(){
        ...
        <div style="padding-left: 30px;">               
		    <form id="advanced_settings_form" method="post" action="">
                <table class="mkrapel-mx-settings-table mkrapel-mx-form-table">
                    <tbody>
                    <?php
	...
	public function print_notices($msg, $type='updated', $return=false){
		$notice = '<div class="mkrapel-mx-notice '. $type .'"><p>'. __($msg, 'wc-ciudades-y-regiones-de-chile') .'</p></div>';
		if(!$return){
			echo $notice;
		}
		return $notice;
